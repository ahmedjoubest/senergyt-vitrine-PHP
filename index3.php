                                        ...
                                        <nav role="navigation"
                                            ...
                                            <ul id="menu-1-b18b572" class="elementor-nav-menu">
                                                ...
                                                <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-27">
                                                    <a href="https://xlab.senergyt.fr/index2.php" class="elementor-item">Apporter
                                                        de la résilience</a></li>
                                                <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-303">
                                                    <a href="https://xlab.senergyt.fr/index3.php" class="elementor-item elementor-item-active">Croiser
                        ...
                        <div class="elementor-widget-wrap elementor-element-populated">
                            <div class="elementor-element elementor-element-cb45e30 elementor-widget elementor-widget-text-editor"
                                            ...
                                            <div class="elementor-widget-wrap elementor-element-populated">
                                                <div class="elementor-element elementor-element-65ef6729 elementor-widget elementor-widget-heading"
                                                    ...
                                                    <div class="elementor-widget-container">
                                                        ...
                                                        <h3 class="elementor-heading-title elementor-size-large">Vers une (r)évolution de l’écosystème de travail pour les exploitants ?</h3></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="elementor-widget-container">
                                    ...
                                    <p style="text-align: center;"> Etudier les modalités pédagogiques et la base méthodologique de mise en œuvre d’une démarche d’action de formation en situation de travail</p>
                                    ...
                                    <p style="text-align: center;"> Responsable de centres de formation de grandes entreprises du secteur, M. X a sensiblement fait évoluer les standards de formation des techniciens grâce à une approche renouvelée et une bonne dose d’audace sur le recrutement</a></p>
                                    ...
                                    <p style="text-align: center;"> - « En 1997, les mecs de la sous-station, il savait ouvrir une vanne vapeur et remettre en service l’installation. Aujourd’hui, avec les procédures, ce n’est plus possible. Ils peuvent fermer les vannes mais ils doivent mobiliser des équipes réseaux pour les remises en service. Dans le gaz, ça ne se passe pas comme ça »</p>
                                    
                                    <p style="text-align: center;"> - « Avant, les gars du réseau, ils savaient faire un presse-étoupe. Aujourd’hui, ils n’ont plus le droit d’y toucher. C’est débile. On doit déplacer du monde, 4 bonhommes, pour mettre 2 coups de clefs ! »</p>
                                    ...
                                    <p style="text-align: center;"> Accélérer la formation de vos collaborateurs et venez considérer les résultats de notre politique de formation SENERGY’T, ainsi que les interactions avec les services techniques et ressources humaines de CPCU </p>
                                    ...
                                    <p style="text-align: center;"> - Découvrez l’action de formation en situation de travail, éligible au financement de la formation professionnelle et gagner la bataille des compétences : <a target="_blank" href="https://agence.erasmusplus.fr/wp-content/uploads/2020/01/GUIDE-AFEST-WEB-1.pdf"> ici </a></p>
                                    
                                    <p style="text-align: center;"> <a target="_blank" href="https://theshiftproject.org/wp-content/uploads/2021/02/Rapport-intermediaire-Former-lingenieur-du-XXIe-siecle.pdf">- Publication du rapport intermédiaire : </a>« former l’ingénieur du XXIème siècle par le Shift Project » </p>
                                    
                                    <p style="text-align: center;"> - Une stratégie bas carbone nécessite l’engagement des collaborateurs pour être fructueuse. Faîtes découvrir la notion d’empreinte carbone par le biais d’une conférence expérientielle à vos salariés : <a target="_blank" href="http://www.carbone4.com/myco2/"> ici </a></p>
                                            ...
                                            <div class="elementor-widget-wrap elementor-element-populated">
                                                <div class="elementor-element elementor-element-65ef6729 elementor-widget elementor-widget-heading"
                                                    ...
                                                    <div class="elementor-widget-container">
                                                        ...
                                                        <h3 class="elementor-heading-title elementor-size-large"> Evolution de nos comportements et des usages en ville ? la démographie et l’urbanisme en question à l’horizon 2050  </h3></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<h4 style="text-align: center;"> X-Lab : Nos propositions </h4>
                                    <p style="text-align: center;"> Le match : machine à laver individuelle ou laverie collective ? </p>
                                    <ul style="position:relative; left: 22%; width: 65%">
                                        <li> Eclairer le potentiel de puissance et d’énergie à l’échelle d’un quartier </li>
                                        <li> Chauffer l’eau des machines avec le réseau de chaleur, quels impacts pour les consommateurs </li>
                                    </ul>
                                    ...
                                    <h4 style="text-align: center;"> Témoignage sous X  </h4>
                                    <p style="text-align: center;"> - « Nous travaillons avec les principaux organes de l’Etat sur les scénarii d’évolution des facteurs de peuplement des espaces urbains à l’horizon 2050. Nous connaissons bien Paris. Nous pourrions apporter nos éclairages sur ces critères pour CPCU ? » </p>
                                    <p style="text-align: center;"> - « Nous connaissons l’existence de travaux d’études pour le compte du réseau de chaleur de la ville de Berlin. Ils ont notamment travaillé sur l’évolution des modalités de chauffage à l’horizon 2050»</p>
                                <div class="rating">
                                        <!-- Thumbs up -->
                                    ...
                                    <h4 style="text-align: center;"> Logarythm'X  </h4>
                                    <p style="text-align: center;"> Baisse de la précarité énergétique : <a target="_blank" href="https://www.futuribles.com/fr/article/la-precarite-energetique-baisse-jusqua-quand/"> jusqu’à quand ? </a> L’analyse de futuribles </p>
                                    <p style="text-align: center;"> Plan de transformation de l’économie française :<a target="_blank" href="https://theshiftproject.org/wp-content/uploads/2021/01/Fiche-Villes-et-Territoires.pdf"> Rapport du Shift Project sur les villes et territoires </a></p>


                                    <div class="rating">
                                        <!-- Thumbs up -->
                                        <div data-value="Intéressé" class="like grow offre8 tooltip">
                                            <span class="tooltiptext">Intéressé</span>
                                            <i class="fa fa-thumbs-up fa-3x like" aria-hidden="true"></i>
                                        </div>
                                        <!-- Thumbs down -->
                                        <div data-value="Non intéressé" class="dislike grow offre8 tooltip">
                                            <span class="tooltiptext">Non intéressé</span>
                                            <i class="fa fa-thumbs-down fa-3x dislike" aria-hidden="true"></i>
                                    ...
                                    <p style="text-align: center;"> Le <a target="_blank" href="https://www.futuribles.com/fr/document/rapport-vigie-2020-scenarios-de-rupture-a-lhorizon/"> rapport VIGIE </a> de Futuribles est disponible : scénarios de rupture à l’horizon 2040-2050 </p>
    
    <p style="text-align: center;">  <a target="_blank" href="https://www.businessimmo.com/contents/126420/manifeste-pour-la-densite"> Manifeste pour la densité urbaine </a>  – A Paris, toujours plus ?</p>
    <p style="text-align: center;"> <a target="_blank" href="https://place-innovation-urbaine.fr/?utm_medium=email&_hsmi=124365365&_hsenc=p2ANqtz-_mzyJ30IzM5RiCE0Od2pzBZaA0yS_0a2H1Xm54GRn3gE5nMRL9R6pbqf6UvYRsqHnCZxJ3UntB5zfTxda7737C5QY-2g&utm_content=124365365&utm_source=hs_email"> Fin de la concertation des acteurs de l’innovation urbaine </a> </p>
        
        <p style="text-align: center;"> Vers des micro-centre de production ? Des opportunités pour le réseau de chaleur parisien ?<a target="_blank" href="https://www.lalessivedeparis.fr/"> L’exemple de la lessive </a> </p>
                                
                                    <div class="rating">
                                        <!-- Thumbs up -->
                                        <div data-value="Intéressé" class="like grow offre9 tooltip">
                                            <span class="tooltiptext">Intéressé</span>
                                            <i class="fa fa-thumbs-up fa-3x like" aria-hidden="true"></i>
                                        </div>
                                        <!-- Thumbs down -->
                                        <div data-value="Non intéressé" class="dislike grow offre9 tooltip">
                                            <span class="tooltiptext">Non intéressé</span>
                                            <i class="fa fa-thumbs-down fa-3x dislike" aria-hidden="true"></i>
...
<section
                                            ...
                                            <div class="elementor-widget-wrap elementor-element-populated">
                                                <div class="elementor-element elementor-element-65ef6729 elementor-widget elementor-widget-heading"
                                                    ...
                                                    <div class="elementor-widget-container">
                                                        ...
                                                        <h3 class="elementor-heading-title elementor-size-large"> Utopies et dystopie : nouvelles technologies ? </h3></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <h4 style="text-align: center;"> Rendez-vous avec M. X </h4>
                                    <img src="https://www.gtanf.com/forums/uploads/monthly_2016_11/Anonyme.png.2fe8ae9fa070b2f938302a0ab399b95d.png" style="display: block; margin-left: auto; margin-right: auto; width: 5%;">
                                    <p style="text-align: center;"> Chef du bureau des activités digitales d’un Ministère Français, M. X est chef de projet et chargé d’étude pour un institut de Prospective</p>
                                    
                                    <div class="rating">
                                        <!-- Thumbs up -->
                                        <div data-value="Intéressé" class="like grow offre10 tooltip">
                                            <span class="tooltiptext">Intéressé</span>
                                            <i class="fa fa-thumbs-up fa-3x like" aria-hidden="true"></i>
                                        </div>
                                        <!-- Thumbs down -->
                                        <div data-value="Non intéressé" class="dislike grow offre10 tooltip">
                                            <span class="tooltiptext">Non intéressé</span>
                                            <i class="fa fa-thumbs-down fa-3x dislike" aria-hidden="true"></i>
                                    ...
                                    <h4 style="text-align: center;"> Témoignage sous X  </h4>
                                    <p style="text-align: center;">« La perte de temps et d’information est énorme. Il y a tellement de logiciels différents, au moins un pour chaque service. Chaque service bosse avec son logiciel, bosser ensemble c’est un merdier sans nom ! »</p>
                                    <div class="rating">
                                        <!-- Thumbs up -->
                                        <div data-value="Intéressé" class="like grow offre11 tooltip">
                                            <span class="tooltiptext">Intéressé</span>
                                            <i class="fa fa-thumbs-up fa-3x like" aria-hidden="true"></i>
                                        </div>
                                        <!-- Thumbs down -->
                                        <div data-value="Non intéressé" class="dislike grow offre11 tooltip">
                                            <span class="tooltiptext">Non intéressé</span>
                                            <i class="fa fa-thumbs-down fa-3x dislike" aria-hidden="true"></i>
                                    ...
                                    <h4 style="text-align: center;"> Logarythm'X  </h4>
                                    <p style="text-align: center;"> Le <a target="_blank" href="https://geode.science/"> projet GEODE </a> étudie la datasphère comme un objet géopolitique à part entière et utilise ces ressources pour produire des analyses géopolitiques. Un Centre d’Excellence du Ministère des Arméees  </p>



                                    <div class="rating">
                                        <!-- Thumbs up -->
                                        <div data-value="Intéressé" class="like grow offre12 tooltip">
                                            <span class="tooltiptext">Intéressé</span>
                                            <i class="fa fa-thumbs-up fa-3x like" aria-hidden="true"></i>
                                        </div>
                                        <!-- Thumbs down -->
                                        <div data-value="Non intéressé" class="dislike grow offre12 tooltip">
                                            <span class="tooltiptext">Non intéressé</span>
                                            <i class="fa fa-thumbs-down fa-3x dislike" aria-hidden="true"></i>
                                    ...
                                    <h4 style="text-align: center;"> X'pression </h4>
                                    <p style="text-align: center;"> - Le nouvel ouvrage de Philippe BIHOUIX est sorti : « Pénurie de ressources : tabou pour l’industrie » - la fascination du high-tech, l’éloge technique de la sobriété et des chemins divergents pour longtemps ? <a target="_blank" href="https://www.cairn.info/revue-projet-2015-6-page-48.htm"> Voir la revue </a> </p>
                                    
                                    <p style="text-align: center;"> - <a target="_blank" href="https://xlab.senergyt.fr/The%20Uncertain%20Promise%20of%20Blockchain%20for%20Government%20-%20Futuribles%20-%20Veille,%20prospective,%20strat%C3%A9gie.pdf"> Article </a> sur les limites de la BlockChain... Futuribles... </p>
                                    
                                    <p style="text-align: center;"> - TESLA :  <a target="_blank" href="https://www.bbc.com/news/business-56897457?xtor=AL-72-%5Bpartner%5D-%5Bbbc.news.twitter%5D-%5Bheadline%5D-%5Bnews%5D-%5Bbizdev%5D-%5Bisapi%5D&at_medium=custom7&at_custom2=twitter&at_custom4=3505FB9C-A711-11EB-82F8-46FD4744363C&at_campaign=64&at_custom3=%40BBCWorld&at_custom1=%5Bpost+type%5D"> des profits tirés par le bitcoin et les crédits carbone </a></p>


                                    <p style="text-align: center;"> - Le cuivre dépasse les 10 000 dollars la tonne, du jamais vu en dix ans. <a target="_blank" href="https://www.sudouest.fr/economie/le-cuivre-depasse-les-10-000-dollars-la-tonne-du-jamais-vu-en-dix-ans-2322324.php"> Voir l'article. </a>  </p>
                                    
                                    <div class="rating">
                                        <!-- Thumbs up -->
                                        <div data-value="Intéressé" class="like grow offre13 tooltip">
                                            <span class="tooltiptext">Intéressé</span>
                                            <i class="fa fa-thumbs-up fa-3x like" aria-hidden="true"></i>
                                        </div>
                                        <!-- Thumbs down -->
                                        <div data-value="Non intéressé" class="dislike grow offre13 tooltip">
                                            <span class="tooltiptext">Non intéressé</span>
                                            <i class="fa fa-thumbs-down fa-3x dislike" aria-hidden="true"></i>
                ...
                <div class="commen-section">
                    ...
                    <div style="text-align: center; margin-bottom: 20px;">
                        ...
                        <input type="hidden" name="offre8" id="offre8" value="NONE">
                        <input type="hidden" name="offre9" id="offre9" value="NONE">
                        <input type="hidden" name="offre10" id="offre10" value="NONE">
                        <input type="hidden" name="offre11" id="offre11" value="NONE">
                        <input type="hidden" name="offre12" id="offre12" value="NONE">
                        <input type="hidden" name="offre13" id="offre13" value="NONE">
...
<script>
    $( document ).ready(function() {
        ...
        $('.offre8.like').on('click', function (e) {
            e.preventDefault();
            offre8.removeClass('active');
            offre8.removeClass('dislikeOffre');
            $(this).addClass('active');
            var value = $(this).attr('data-value');
            $('#offre8').val(value);
        });

        $('.offre8.dislike').on('click', function (e) {
            e.preventDefault();
            offre8.removeClass('active');
            offre8.removeClass('dislikeOffre');
            $(this).addClass('dislikeOffre');
        ...
        $('.offre9.like').on('click', function (e) {
            e.preventDefault();
            offre9.removeClass('active');
            offre9.removeClass('dislikeOffre');
            $(this).addClass('active');
            var value = $(this).attr('data-value');
            $('#offre9').val(value);
        });

        $('.offre9.dislike').on('click', function (e) {
            e.preventDefault();
            offre9.removeClass('active');
            offre9.removeClass('dislikeOffre');
            $(this).addClass('dislikeOffre');
        ...
        $('.offre10.like').on('click', function (e) {
            e.preventDefault();
            offre10.removeClass('active');
            offre10.removeClass('dislikeOffre');
            $(this).addClass('active');
            var value = $(this).attr('data-value');
            $('#offre10').val(value);
        });

        $('.offre10.dislike').on('click', function (e) {
            e.preventDefault();
            offre10.removeClass('active');
            offre10.removeClass('dislikeOffre');
            $(this).addClass('dislikeOffre');
        ...
        $('.offre11.like').on('click', function (e) {
            e.preventDefault();
            offre11.removeClass('active');
            offre11.removeClass('dislikeOffre');
            $(this).addClass('active');
            var value = $(this).attr('data-value');
            $('#offre11').val(value);
        });

        $('.offre11.dislike').on('click', function (e) {
            e.preventDefault();
            offre11.removeClass('active');
            offre11.removeClass('dislikeOffre');
            $(this).addClass('dislikeOffre');
        ...
        $('.offre12.like').on('click', function (e) {
            e.preventDefault();
            offre12.removeClass('active');
            offre12.removeClass('dislikeOffre');
            $(this).addClass('active');
            var value = $(this).attr('data-value');
            $('#offre12').val(value);
        });

        $('.offre12.dislike').on('click', function (e) {
            e.preventDefault();
            offre12.removeClass('active');
            offre12.removeClass('dislikeOffre');
            $(this).addClass('dislikeOffre');
        ...
        $('.offre13.like').on('click', function (e) {
            e.preventDefault();
            offre13.removeClass('active');
            offre13.removeClass('dislikeOffre');
            $(this).addClass('active');
            var value = $(this).attr('data-value');
            $('#offre13').val(value);
        });

        $('.offre13.dislike').on('click', function (e) {
            e.preventDefault();
            offre13.removeClass('active');
            offre13.removeClass('dislikeOffre');
            $(this).addClass('dislikeOffre');
