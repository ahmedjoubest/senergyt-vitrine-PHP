                                        ...
                                        <nav role="navigation"
                                            ...
                                            <ul id="menu-1-b18b572" class="elementor-nav-menu">
                                                ...
                                                <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-78">
                                                    <a href="https://xlab.senergyt.fr/index1.php" class="elementor-item elementor-item-active">Rationaliser
                        ...
                        <div class="elementor-widget-wrap elementor-element-populated">
                            <div class="elementor-element elementor-element-cb45e30 elementor-widget elementor-widget-text-editor"
                                            ...
                                            <div class="elementor-widget-wrap elementor-element-populated">
                                                <div class="elementor-element elementor-element-65ef6729 elementor-widget elementor-widget-heading"
                                                    ...
                                                    <div class="elementor-widget-container">
                                                        ...
                                                        <h3 class="elementor-heading-title elementor-size-large">L’intérêt des micro-boucles d’eau chaude ?</h3></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="elementor-widget-container">
                                    ...
                                    <p style="text-align: center;">L’Hôtel « Le Swan », starter des études visant la mise en place d’un micro-boucle d’eau chaude dans la rue de Constantinople à Paris ?</p>
                                    <ul style="position:relative; left: 22%; width: 65%">
                                        <li>Avant-Projet Sommaire : raccordement de l’Hôtel Le Swan :
                                        <br>
                                        <b style="margin-left: 0.6em;">→</b> Extension pour une opération de conception-réalisation </li>
                                        <li>Extension des travaux de design technique et financier à l’échelle de la rue :
                                        <br>
                                        <b style="margin-left: 0.6em;">→</b>Freins et opportunité pour la mise en œuvre d’une micro-boucle d’eau chaude dans cette rue qui n’est pas desservie par CPCU </li>
                                    </ul>
                                    <div class="rating">
                                        <!-- Thumbs up -->
                                    ...
                                    <p style="text-align: center;"> Nouveau matériau : les tubes flexibles un atout pour baisser les coûts. <a target="_blank" href="https://xlab.senergyt.fr/Presentation_AXIOM_Tubes_14-04-21.pdf">Télécharger la présentation AXIOM.</a></p>
                                    ...
                                    <p style="text-align: center;"> Stocker de l’eau chaude pour effacer les crêtes à l’échelle d’un tronçon ? Pour quel rendement ? <a target="_blank" href="https://www.linkedin.com/posts/damien-petiteau-58228571_raezseaudechaleur-biomasse-activity-6793863248862171136-i45t/">Un exemple concret ici</a></p>
                                    
                                    <p style="text-align: center;"> LONDRES : <a target="_blank" href="https://www-theagilityeffect-com.cdn.ampproject.org/c/s/www.theagilityeffect.com/fr/review/londres-va-utiliser-la-chaleur-du-metro-pour-se-chauffer/?amp">se chauffer avec le TUBE ? </a></p>
                                            ...
                                            <div class="elementor-widget-wrap elementor-element-populated">
                                                <div class="elementor-element elementor-element-65ef6729 elementor-widget elementor-widget-heading"
                                                    ...
                                                    <div class="elementor-widget-container">
                                                        ...
                                                        <h3 class="elementor-heading-title elementor-size-large">Densifier le réseau de chaleur de Paris : freins et opportunités ? </h3></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<h4 style="text-align: center;"> X-Lab : Nos propositions </h4>
                                    <p style="text-align: center;">Elargir les capacités de prospection commerciales pour le réseau de chaleur de la ville de Paris. Contributions à des approches renouvelées et mise en place d’un réseau d’agents commerciaux à l’échelle d’un quartier ?</p>
                                    <div class="rating">
                                        <!-- Thumbs up -->
                                    ...
                                    <p style="text-align: center;">Demandeurs et volontaires pour obtenir une proposition de raccordement à CPCU, Ms. X. peuvent apporter un témoignage intéressant sur le brouillard des relations clients de CPCU</p>
                                <div class="rating">
                                        <!-- Thumbs up -->
                                    ...
                                    <h4 style="text-align: center;"> Logarythm'X  </h4>
                                    <p style="text-align: center;"> Retour d’expérience sur les contraintes de raccordement pour les petites puissances : Notre projet de raccordement 63 Rue de l’Université </a></p>
                                            ...
                                            <div class="elementor-widget-wrap elementor-element-populated">
                                                <div class="elementor-element elementor-element-65ef6729 elementor-widget elementor-widget-heading"
                                                    ...
                                                    <div class="elementor-widget-container">
                                                        ...
                                                        <h3 class="elementor-heading-title elementor-size-large">Refroidissement par évaporation ? l’étendue du réseau vapeur, un atout pour l’avenir aux portes de Paris ? </h3></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<h4 style="text-align: center;"> Rendez-vous avec M. X </h4>
                                    <img src="https://www.gtanf.com/forums/uploads/monthly_2016_11/Anonyme.png.2fe8ae9fa070b2f938302a0ab399b95d.png" style="display: block; margin-left: auto; margin-right: auto; width: 5%;">
                                    <p style="text-align: center;"> Physicien & praticien, M. X. dispose d’une longue expérience internationale et une connaissance fine de CPCU</p>
                                    ...
                                    <p style="text-align: center;">La chaleur, on peut se débrouiller à l’échelle de la commune et de la communauté de communes. Pour l’eau glacée, nous sommes dans l’inconnu… C’est pourtant nos enjeux de demain et nous regardons arriver l’été avec des craintes pour le confort de nos concitoyens chaque année ...</p>
                                    <div class="rating">
                                        <!-- Thumbs up -->
                                    ...
                                    <h4 style="text-align: center;"> X'pression </h4>
                                    <p style="text-align: center;"> Un point sur le <a target="_blank" href="https://fr.wikipedia.org/wiki/Refroidisseur_par_%C3%A9vaporation"> refroidissement par évaporation </a> </p>
                                    <p style="text-align: center;"> Quelques informations techniques </p>
                                    <ul style="position:relative; left: 45%; width: 65%">
                                        <li><a target="_blank" href="https://xlab.senergyt.fr/abscours.pdf"> Source 1 </a></li>
                                        <li><a target="_blank" href="https://xlab.senergyt.fr/TwoStepInfographic.pdf"> Source 2 </a></li>
                                        <li><a target="_blank" href="https://xlab.senergyt.fr/YORKSteamBrochure.pdf"> Source 3 </a></li>
                                        <li><a target="_blank" href="https://xlab.senergyt.fr/Steam_driven.pdf"> Source 4 </a></li>
                                    </ul>
                                    <div class="rating">
                                        <!-- Thumbs up -->
